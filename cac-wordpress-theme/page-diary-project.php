      ...
      <div class="eachDiaryContents--frame">
        <div class="eachDiaryContents--sentence">
          ...
          <div class="diaryContents__cell--frame">
            <a href="<332ed719f843cd2a96941484f1e80133 />">
              <!-- サムネイルの表示 -->
              ...
              <?php
                                    ...
                                    ?>
              <?php else: ?>
              <img class="diaryContents__cell--img" src="<f566b5252d4aabebd5f307b5c837cfaa />/img/diary/NoImage.jpg"/>
              <?php endif; ?>
              <!-- カテゴリを表示（複数可） -->
          ...
          <div class="diaryContents__noCongtentsMessage__background">
            <div class="diaryContents__noCongtentsMessage--frame">現在は掲載中の「プロジェクト」は御座いません。 </div>
          </div>
