      ...
      <div class="eachDiaryContents--frame">
        <div class="eachDiaryContents--sentence">
          ...
          <div class="diaryContents__cell--frame">
            <a href="<9756e644f71084a3add5e946ad20ee03 />">
              <!-- サムネイルの表示 -->
              <?php if( has_post_thumbnail() ): ?>
              <?php
                                    the_post_thumbnail(
                                        [
                                            300, 350                              //サムネイル画像の大きさを指定
                                        ],
                                        [
                                    ...
                                    ?>
              <?php else: ?>
              <img class="diaryContents__cell--img" src="<86c9942e576e4a688b7820a331d61dd8 />/img/diary/NoImage.jpg"/>
              <?php endif; ?>
              <!-- カテゴリを表示（複数可） -->
