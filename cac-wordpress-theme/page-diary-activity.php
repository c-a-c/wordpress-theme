      ...
      <div class="eachDiaryContents--frame">
        <div class="eachDiaryContents--sentence">
          ...
          <div class="diaryContents__cell--frame">
            <a href="<2a645b5ae8356128f73b58017b85b121 />">
              <!-- サムネイルの表示 -->
              ...
              <?php
                                    ...
                                    ?>
              <?php else: ?>
              <img class="diaryContents__cell--img" src="<396a9545eaa7447e592762ef1af55df8 />/img/diary/NoImage.jpg"/>
              <?php endif; ?>
              <!-- カテゴリを表示（複数可） -->
          ...
          <div class="diaryContents__noCongtentsMessage__background">
            <div class="diaryContents__noCongtentsMessage--frame">現在は掲載中の「活動日誌」は御座いません。 </div>
          </div>
