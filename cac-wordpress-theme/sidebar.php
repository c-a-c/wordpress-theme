<div class="eachDiaryContents--subMenu">
  ...
  <div class="subMenu__cell--frame">
    <a href="<1611ec1dac69939be8f8ff22e7c83ff2 />" class="subMenu__cell--contentsFrame">
      <!-- メイン画像を指定 -->
      ...
      <?php
                    ...
                    ?>
      <?php else: ?>
      <img class="subMenu__cell--img" src="<9eafc360ce8f50f95a42285cc62e2cb0 />/img/diary/NoImage_mini.jpg"/>
      <?php endif; ?>
  ...
  <h2 class="diary subMenu__cell--frame--right">アクセスランキング</h2>
  <?php
  ...
  <div class="subMenu__cell--frame--right">
    <a href="<e59de70fbc9022918939e2ffe20abee1 />" class="subMenu__cell--contentsFrame">
      <!-- メイン画像を指定 -->
      <?php if( has_post_thumbnail() ): ?>
      <?php
                    the_post_thumbnail(
                    ...
                    ?>
      <?php else: ?>
      <img class="subMenu__cell--img" src="<9dafe7d1f5d67cd7629ea6ff936aeedc />/img/diary/NoImage_mini.jpg"/>
      <?php endif; ?>
      <div class="subMenu__cell--titleFrame">
        <h3 class="subMenu__cell--title">
          <?php the_title(); ?>
  ...
  <div class="subMenu__cell--frame"></div>
</div>