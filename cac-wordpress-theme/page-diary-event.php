...
<html>
  ...
  <body>
    ...
    <div class="subPageHeader" style="background-color: rgba(255, 255, 255, 0.8);">
      <div class="subPageTitle" style="color: #545454;">ダイアリー </div>
      <div class="subPageSentence" style="color: #545454;">弊団体の部員の普段の活動をブログ形式で紹介します。 </div>
    </div>
    <!-- start main contents -->
        ...
        <div class="eachDiaryContents--sentence">
          ...
          <?php
                        ...
                        $the_query = new WP_Query([
                            'category_name' => 'ダイアリー+行事', //カテゴリー名の指定
          ...
          <div class="diaryContents__cell--frame">
            <a href="<cfebff24e61fe55a0ca22cfead852e5f />">
              <!-- サムネイルの表示 -->
              ...
              <?php
                                    ...
                                    ?>
              <?php else: ?>
              <img class="diaryContents__cell--img" src="<e94f92f1e9427e33c946dd9598aeb749 />/img/diary/NoImage.jpg"/>
              <?php endif; ?>
              <!-- カテゴリを表示（複数可） -->
              ...
              <!-- 文章の一部を表示 -->
              <p class="diary">
                <?php add_new_line_on_except( get_the_excerpt(), 23); ?>
              </p>
            </a>
          </div>
          <?php endwhile; else : ?>
          <div class="diaryContents__noCongtentsMessage__background">
            <div class="diaryContents__noCongtentsMessage--frame">現在は掲載中の「行事」は御座いません。 </div>
          </div>
