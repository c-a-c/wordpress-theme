...
<html>
  <head>
    <title>
      <?php the_title(); ?>| C.A.C. | 京都産業大学 文化団体連盟所属 電子計算機応用部 
    </title>
    <meta charset="UTF-8">
        ...
        <div class="eachDiaryContents--sentence">
          <div class="diary_Article--info">
            <div class="diaryAritcle__cell--categoryFrame">
              ...
              <h2 class="diary_Article--postdate">
                <time datetime="<da79e80c1c151b6dba262011d620f225 />">
          ...
          <article 
            ...
            <div class="article-info">
              ...
              <!--投稿日を取得-->
              <time datetime="<ada5f73f4ceb19cc3599c36016446885 />">
                <?php echo get_the_date( 'Y/m/d' ); ?>
              </time>
              </span>
              <!--著者を取得-->
            ...
            <?php
                            ...
                            ?>
            <?php else: ?>
            <img class="diaryContents__cell--img" src="<b1954e47805500c693ab8c09ee7935f7 />/img/diary/SampleImage.jpg"/>
            <?php endif; ?>
            <!--本文取得-->
            <?php the_content(); ?>
            <!--タグ-->
