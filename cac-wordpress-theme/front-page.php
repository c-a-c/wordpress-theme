...
<html>
  ...
  <body>
    ...
    <div class="mainTitle">
      ...
      <div class="mainTitle__titleJapanese_cellphone">「作るだけ」で、
        <br>終わらせない
      </div>
    </div>
    <div class="mainMenu">
      <div class="mainMenu__aboutLink" onclick="document.location.href = 'http://localhost:8080/about'" onmouseout="hoverMainMenu('about', false);" onmouseover="hoverMainMenu('localhost:8080/about', true);">
        <div class="mainMenu__imageLeft" id="mainMenu__aboutLink" style="background-image: url('<82f7068d30cbfe63b43a4d27a9d5f812 />/img/top/mainMenu_about.png');">
        ...
        <div class="mainMenu__discriptionRight" style="background-color: #bedf69;">
          <div class="mainMenu__discriptionLogo" style="background-image: url('<d32414063355a42be7bedc34950f3848 />/img/top/mainMenu_logo_弊団体について.png');"></div>
      ...
      <div class="mainMenu__projectLink" onclick="document.location.href = 'http://localhost:8080/project'" onmouseout="hoverMainMenu('project', false);" onmouseover="hoverMainMenu('project', true);">
        <div class="mainMenu__imageRight" id="mainMenu__projectLink" style="background-image: url('<793a5b3e4d57a8021d16f97d9b89e6b8 />/img/top/mainMenu_project.png');"></div>
        <div class="mainMenu__discriptionLeft" style="background-color: #69abdf;">
          <div class="mainMenu__discriptionLogo" style="background-image: url('<e16367fc6e415887afc5261f76cdf9d6 />/img/top/mainMenu_logo_プロジェクト.png');"></div>
      ...
      <div class="mainMenu__diaryLink" onclick="document.location.href = 'http://localhost:8080/diary'" onmouseout="hoverMainMenu('diary', false);" onmouseover="hoverMainMenu('diary', true);">
        <div class="mainMenu__imageLeft" id="mainMenu__diaryLink" style="background-image: url('<061c9a8c5ed26e2f10be124a9f8cc738 />/img/top/mainMenu_diary.png');">
        ...
        <div class="mainMenu__discriptionRight" style="background-color: #d069df;">
          <div class="mainMenu__discriptionLogo" style="background-image: url('<eae9401233bf6a220b27e9e80fd38889 />/img/top/mainMenu_logo_ダイアリー.png');"></div>
    ...
    <div class="mainDiary">
      ...
      <div class="mainDiary__diary">
        ...
        <div class="mainDiary__diary--contents">
          <a href="<16f8eb9bc4025b239948c2130f6c1494 />">
            <!-- サムネイルの表示 -->
            ...
            <?php 
                                ...
                                ?>
            <?php else: ?>
            <img class="mainDiary__diary--logo" src="<ffccd15cd50b0c3023252b5f72585f74 />/img/top/NoImage.jpg"/>
            <?php endif; ?>
            <!-- 記事タイトルの表示 -->
        ...
        <?php endwhile; else : ?>
        <div class="mainDiary__diary--contents" style="text-align:center">現在は掲載中のダイアリーは御座いません。 </div>
        <?php endif; wp_reset_postdata(); ?>
        <!-- PHPのループ終了　-->
        <a class="mainDiary__moreButton" href="<7fde9fde2e3e10b1d90505ebf1405073 />">more</a>
      </div>
