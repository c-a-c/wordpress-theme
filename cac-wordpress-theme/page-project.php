    ...
    <body>
        ...
        <div class="projectContents__background">
            <div class="projectContents__background--frame">
                ...
                ?>
                    <a href="<?php the_permalink(); ?>" class="projectContents__cell--base" onmouseover="hoverProjectContents(true, this);" onmouseout="hoverProjectContents(false, this);" style="text-decoration: none;">
                        <!-- サムネイルの表示 -->
